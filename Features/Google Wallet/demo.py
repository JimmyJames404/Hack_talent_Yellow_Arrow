...
if __name__ == "__main__":
    ...
    issuer_id = os.environ.get("WALLET_ISSUER_ID", "3388000000022315698")
    class_suffix = os.environ.get("WALLET_CLASS_SUFFIX", "nexo") + demo.__class__.__name__
    object_suffix = os.environ.get("WALLET_OBJECT_SUFFIX", "ticket") + demo.__class__.__name__
